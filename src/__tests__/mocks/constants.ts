...
export const defaultValues = {
  ...
  username: "username",
  password: "password",
  poolId: "eu-west-2_bBpjKlyj6",
  // client session
  // username: <same as above>,
  poolIdAbbr: "bBpjKlyj6",
  passwordHash:
    "266629fd96baf8f433a4f01562eea59dd99a721dac75ae600e06bc697b2016ff",
  smallA: "abcdef0123456789",
  largeA:
  ...
  salt: "8f6a1dad94d7b82c5e3031d21a251b0f",
  secret:
  ...
  // timestamp
  date: new Date(949374245000), // Used when mocking internal date/time
  timestamp: "Tue Feb 1 03:04:05 UTC 2000",
  // password signature
  passwordSignature: "AmaS40dQC4mBIgVaKNkAvWpYBmHUi/gv/XKVVCr8xyE=", // This value is computed using all of the above inputs
};
